...
|---|---|---|
| `agentic-apps-workflow-SKILL.md` | `.claude/skills/agentic-apps-workflow/SKILL.md` | `skill/SKILL.md` (trigger skill; parity §7 probes it for the OpenSpec-era verification section) |
