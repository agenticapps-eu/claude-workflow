...
# Real family (with child .git)
mkdir -p "$HOME/Sourcecode/agenticapps/claude-workflow/.git"
# Non-family dir (no child .git)
mkdir -p "$HOME/Sourcecode/experiments/notes"
echo "loose file" > "$HOME/Sourcecode/experiments/notes/whatever.txt"
