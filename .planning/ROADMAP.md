...
Plans:
- [ ] 25-01-PLAN.md — Wave 0: ADRs 0031/0032/0033 + RED fixtures (08, 09, 10, 11, 0021/01) + RED queue-monitor.test.ts × 3 stacks
...
|-------|----------------|--------|-----------|
| 25. Fix 0019 engine + withCronMonitor | 0/5 | Not started | - |
