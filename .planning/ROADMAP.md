...
Plans:
- [ ] 26-01-PLAN.md — Wave 0: ADR-0034 + RED fixture 13 + RED idempotency test stubs × 4 stacks (sets up Nyquist RED baseline)
...
| 26. worker-template hardening | 0/3 | Planning complete — ready to execute | - |
