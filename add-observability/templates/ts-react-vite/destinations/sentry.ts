/**
 * Sentry destination adapter — AgenticApps spec §10.8 (ts-react-vite / browser).
 *
 * Phase 21 (P2.1). Lift-and-shift of the wrapper's inline `@sentry/react` calls
 ...
 *
 *   - init             calls `Sentry.init({ dsn, ... })` when VITE_SENTRY_DSN
 *                      is present. The browser DSN is a public key by design.
